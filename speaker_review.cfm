...
<cfif Len(speakerFeedbackObj.getSpeakerFeedbackId()) OR speakerFeedbackObj.getSpeakerFeedbackId()>
...
<html lang="en">
  <head>
    ...
    <title><cfoutput>#APPLICATION.siteName#</cfoutput> &raquo; Speaker Review</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="../index.cfm"><cfoutput>#APPLICATION.siteLongName#</cfoutput></a> <span class="navbar-brand">&raquo; Speaker Review</span>
        </div>
      </div>
    </div>
	  ...
	  <div class="row">
        <div class="col-md-12">
		  ...
		  <cfoutput>
			...
			<input type="hidden" name="ff#Hash('reviewType','SHA-384')#" value="#APPLICATION.utils.dataEnc( 'speaker', 'form' )#" />
			#APPLICATION.utils.getRandomFormField()#
			<fieldset>
			
			<!--- Form Name --->
			<legend>Review Speaker &raquo; Leave Feedback</legend>
			
			<!--- Text input--->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="punctuality">Punctuality</label>  
			  <div class="col-md-4">
			  <input id="punctuality" name="punctuality" type="number" class="rating" data-min="0" data-max="5" data-step="1" data-size="xs" data-stars="5" data-show-clear="false">
		  	  <span class="help-block">How punctual was the speaker?</span>  
			  </div>
			</div>
			
			<!--- Text input--->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="preparedness">Preparedness</label>  
			  <div class="col-md-4">
			  <input id="preparedness" name="preparedness" type="number" class="rating" data-min="0" data-max="5" data-step="1" data-size="xs" data-stars="5" data-show-clear="false">
		  	  <span class="help-block">Was the speaker properly prepared for their talk?</span>  
			  </div>
			</div>
			
			<!--- Text input--->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="knowledge">Knowledge</label>  
			  <div class="col-md-4">
			  <input id="knowledge" name="knowledge" type="number" class="rating" data-min="0" data-max="5" data-step="1" data-size="xs" data-stars="5" data-show-clear="false">
		  	  <span class="help-block">Was the speaker knowledgeable of the topic they presented?</span>  
			  </div>
			</div>
			
			<!--- Text input--->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="quality">Quality</label>  
			  <div class="col-md-4">
			  <input id="quality" name="quality" type="number" class="rating" data-min="0" data-max="5" data-step="1" data-size="xs" data-stars="5" data-show-clear="false">
		  	  <span class="help-block">How was the quality of the material presented?</span>  
			  </div>
			</div>
			
			<!--- Text input--->
			<div class="form-group">
			  <label class="col-md-4 control-label" for="satisfaction">Satisfaction</label>  
			  <div class="col-md-4">
			  <input id="satisfaction" name="satisfaction" type="number" class="rating" data-min="0" data-max="5" data-step="1" data-size="xs" data-stars="5" data-show-clear="false">
		  	  <span class="help-block">Overall, how satisfied are you with this speaker?</span>  
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <input id="recommend" name="recommend" type="number" class="rating" data-min="0" data-max="5" data-step="1" data-size="xs" data-stars="5" data-show-clear="false">
		  	  <span class="help-block">Would you recommend this speaker to others?</span>  
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <span class="help-block">Enter your <strong>public</strong> comments about this speaker and/or presentation.</span>  
			  </div>
			</div>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
				<button type="submit" id="btn_Submit" name="btn_Submit" class="btn btn-success">Leave Speaker Feedback</button>
